                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> 学生列表<?php if(($catename) != ""): ?>— <?php echo ($catename); endif; ?></span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column table_managed_sample" style="border-bottom:none">
                                        ...
                                        <tbody>
                                        	<?php if(is_array($studentlist)): $i = 0; $__LIST__ = $studentlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$student): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                                <td><?php echo ($student["s_id"]); ?></td>
                                               	<td><?php echo ($student["s_name"]); ?></td>
                                                <td><?php echo ($student["s_pnum"]); ?></td>
                                                <td><?php echo ($student["s_grade"]); ?></td>
                                                <td><?php echo ($student["s_sex"]); ?></td>
                                                <td><?php echo ($studet["s_school"]); ?></td>
                                                <td>
                                                	<span><i class="fa fa-edit"></i> <a href="?c=admin&a=book_one&id=<?php echo ($one["id"]); ?>">编辑</a> </span>
                                                    <!-- &nbsp;|&nbsp; <span><i class="fa fa-times"></i> <a href="?c=admin&a=scenic_delete&id=<?php echo ($one["id"]); ?>" onClick="return confirm('您确定进行删除操作吗？删除将不可恢复！')">删除</a> </span>--> 
                                                    <?php if(($category) != "0"): ?><span><i class="fa fa-edit"></i> <a href="?c=admin&a=book_dropCategory&id=<?php echo ($one["id"]); ?>&category=<?php echo ($category); ?>">从分类删除</a> </span><?php endif; ?>
                                                </td>
