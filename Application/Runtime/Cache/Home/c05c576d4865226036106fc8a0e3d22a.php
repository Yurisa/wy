                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column table_managed_sample" style="border-bottom:none">
                                        ...
                                        <tbody>
                                        	<?php if(is_array($today_class)): $i = 0; $__LIST__ = $today_class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                                <td><?php echo ($class["c_id"]); ?></td>
                                               	<td><?php echo ($class["name"]); ?></td>
                                                <td><?php echo (date('Y-m-d',$class["starttime"])); ?></td>
                                                <td><?php echo (date('Y-m-d',$class["endtime"])); ?></td>
                                                <td>
