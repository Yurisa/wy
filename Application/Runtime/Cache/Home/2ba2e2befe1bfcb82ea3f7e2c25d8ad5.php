		...
		<div class="studentTable">
			<table cellpadding="0" cellspacing="15" border="0" width="100%">
				...
				<tr>
					...
					<td><?php echo ($studentdata["s_department"]); ?></td>
				</tr>
				<tr>
					<td></td>
					<td><font class="label">所属专业</font></td>
					<td><?php echo ($studentdata["s_professsion"]); ?></td>
				</tr>
				<tr>
					<td></td>
					<td><font class="label">性别</font></td>
					<td><?php echo ($studentdata["s_sex"]); ?></td>
				</tr>
				<tr>
					<td></td>
					<td><font class="label">入学时间</font></td>
					<td><?php echo ($studentdata["s_adtime"]); ?></td>
				</tr>
				<tr>
					<td colspan="3"></td>
				</tr>
		...
		<div class="box bottom">
			<table>
				<tr>
					...
					<td>:</td>
					<td><?php echo ($studentdata["openid"]); ?></td>
				</tr>
			</table>
		</div>
	</div>
