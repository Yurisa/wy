...
* @Last Modified time: 2017-05-10 21:25:35
*/
var courseTime=1;
var timeValue;
var weekValue;
...
window.onload=function(){
            ...
            document.getElementById("background").style.height=height_1+'px';
            document.getElementById("container").style.height=height_1-23+'px';
        ...
        function del_ff(elem){
         ...
         function deletebox(val){
            ...
            if(table.id=="ClassTable_1")
                ...
                document.getElementById("container_1").removeChild(table);
                courseTime--;
            }
        }
        function addtime(val){
            ...
            document.getElementById("addTime").style.top=document.getElementById("container").scrollTop+110+'px';
        ...
        function addWeek(val){
            ...
            document.getElementById("blackBg").style.height=window.screen.height+'px';
            document.getElementById("blackBg").style.display="block";
            document.getElementById("addWeek").style.top=document.getElementById("container").scrollTop+100+'px';
